...
'Item',
 ...
 'Despavimentado'])
### list of periods
periodos2= pd.DataFrame(columns= ["year", "month"])
periodos2.loc[0]=[2021, "Jul"]
periodos2= pd.concat([periodos2, periodos[(periodos['month']=="Sep") | (periodos['month']=="Dic") | (periodos['month']=="Mar") |(periodos['month']=="Jun")]])
periodos2
year= str(periodos2.loc[0,"year"])
month= periodos2.loc[0,"month"]
file= year+month
dir= os.path.join("..\\output", file)
os.chdir(dir)
#### first set the month 
...
roll_out= driver.find_element(By.XPATH,"//select[@class='ui-datepicker-year']")
roll_out.click()
